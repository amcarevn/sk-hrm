...
const CompanyUnitList: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900">Quản lý Đơn vị làm việc</h1>
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="mb-6 bg-gray-50 p-4 rounded-lg">
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-lg font-semibold text-gray-900">Tìm kiếm đơn vị</h3>
            {loading && (
        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            <h2 className="text-lg font-semibold text-gray-900">Danh sách Đơn vị</h2>
            <p className="text-gray-500 text-sm">Tổng số: {units.length} đơn vị</p>
          </div>
          <button
          ...
          <div className="border rounded-lg overflow-hidden">
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Mã định danh</th>
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Mã nhận diện</th>
                ...
                <tr>
                  <td colSpan={4} className="px-6 py-12 text-center text-gray-500">
                    <div className="flex flex-col items-center">
                      ...
                      <p className="text-lg font-medium text-gray-900">Chưa có đơn vị làm việc nào</p>
                    </div>
                  </td>
                </tr>
              </tbody>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {units.map((unit) => (
                  <tr key={unit.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm font-medium text-gray-900">{unit.prefix_code || '—'}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900 font-medium">{unit.name}</div>
                    </td>
                    <td className="px-6 py-4 max-w-xs truncate">
                      <div className="text-sm text-gray-500 truncate" title={unit.description}>
                        {unit.description || '—'}
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <button
                        ...
                        className={`${
                          unit.is_active ? 'bg-emerald-600' : 'bg-gray-200'
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 overflow-y-auto">
          <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            <div className="fixed inset-0 bg-gray-500 bg-opacity-75" onClick={() => !modalLoading && setIsModalOpen(false)}></div>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="bg-white px-6 py-4 border-b border-gray-200 flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="text-gray-400 hover:text-gray-500 transition disabled:opacity-50"
                ...
                <div className="bg-white px-6 pt-5 pb-4 sm:pb-6 space-y-4">
                  {modalError && (
                ...
                <div className="bg-gray-50 px-6 py-4 flex flex-row-reverse gap-3 border-t border-gray-200">
                  <button
                    type="submit"
                    disabled={modalLoading}
                    className="bg-primary-600 text-white px-4 py-2 rounded-md hover:bg-primary-700 transition-colors text-sm font-medium disabled:opacity-60"
                  >
